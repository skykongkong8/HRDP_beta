...
hrdp_beta_actions__action__CameraRGB_Goal__create()
{
  ...
  hrdp_beta_actions__action__CameraRGB_Goal * msg = (hrdp_beta_actions__action__CameraRGB_Goal *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hrdp_beta_actions__action__CameraRGB_Goal));
  bool success = hrdp_beta_actions__action__CameraRGB_Goal__init(msg);
  if (!success) {
...
hrdp_beta_actions__action__CameraRGB_Goal__destroy(hrdp_beta_actions__action__CameraRGB_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    hrdp_beta_actions__action__CameraRGB_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
hrdp_beta_actions__action__CameraRGB_Goal__Sequence__init(hrdp_beta_actions__action__CameraRGB_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_Goal * data = NULL;

  if (size) {
    data = (hrdp_beta_actions__action__CameraRGB_Goal *)allocator.zero_allocate(size, sizeof(hrdp_beta_actions__action__CameraRGB_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hrdp_beta_actions__action__CameraRGB_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hrdp_beta_actions__action__CameraRGB_Goal__fini(&data[i - 1]);
      }
...
hrdp_beta_actions__action__CameraRGB_Goal__Sequence__fini(hrdp_beta_actions__action__CameraRGB_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hrdp_beta_actions__action__CameraRGB_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_Goal__Sequence * array = (hrdp_beta_actions__action__CameraRGB_Goal__Sequence *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hrdp_beta_actions__action__CameraRGB_Goal__Sequence__init(array, size);
  if (!success) {
...
hrdp_beta_actions__action__CameraRGB_Goal__Sequence__destroy(hrdp_beta_actions__action__CameraRGB_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hrdp_beta_actions__action__CameraRGB_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hrdp_beta_actions__action__CameraRGB_Goal__Sequence__are_equal(const hrdp_beta_actions__action__CameraRGB_Goal__Sequence * lhs, const hrdp_beta_actions__action__CameraRGB_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hrdp_beta_actions__action__CameraRGB_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hrdp_beta_actions__action__CameraRGB_Goal);
    hrdp_beta_actions__action__CameraRGB_Goal * data =
      (hrdp_beta_actions__action__CameraRGB_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hrdp_beta_actions__action__CameraRGB_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          hrdp_beta_actions__action__CameraRGB_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_Goal__copy(
...
hrdp_beta_actions__action__CameraRGB_Result__init(hrdp_beta_actions__action__CameraRGB_Result * msg)
{
  ...
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->sequence, 0)) {
    hrdp_beta_actions__action__CameraRGB_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_Result * msg = (hrdp_beta_actions__action__CameraRGB_Result *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hrdp_beta_actions__action__CameraRGB_Result));
  bool success = hrdp_beta_actions__action__CameraRGB_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_Result__Sequence__init(hrdp_beta_actions__action__CameraRGB_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_Result * data = NULL;

  if (size) {
    data = (hrdp_beta_actions__action__CameraRGB_Result *)allocator.zero_allocate(size, sizeof(hrdp_beta_actions__action__CameraRGB_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hrdp_beta_actions__action__CameraRGB_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        hrdp_beta_actions__action__CameraRGB_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
hrdp_beta_actions__action__CameraRGB_Result__Sequence__fini(hrdp_beta_actions__action__CameraRGB_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      hrdp_beta_actions__action__CameraRGB_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_Result__Sequence * array = (hrdp_beta_actions__action__CameraRGB_Result__Sequence *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hrdp_beta_actions__action__CameraRGB_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_Result__Sequence__destroy(hrdp_beta_actions__action__CameraRGB_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hrdp_beta_actions__action__CameraRGB_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hrdp_beta_actions__action__CameraRGB_Result__Sequence__are_equal(const hrdp_beta_actions__action__CameraRGB_Result__Sequence * lhs, const hrdp_beta_actions__action__CameraRGB_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hrdp_beta_actions__action__CameraRGB_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hrdp_beta_actions__action__CameraRGB_Result);
    hrdp_beta_actions__action__CameraRGB_Result * data =
      (hrdp_beta_actions__action__CameraRGB_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hrdp_beta_actions__action__CameraRGB_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          hrdp_beta_actions__action__CameraRGB_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
hrdp_beta_actions__action__CameraRGB_Feedback__init(hrdp_beta_actions__action__CameraRGB_Feedback * msg)
{
  ...
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->partial_sequence, 0)) {
    hrdp_beta_actions__action__CameraRGB_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_Feedback * msg = (hrdp_beta_actions__action__CameraRGB_Feedback *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hrdp_beta_actions__action__CameraRGB_Feedback));
  bool success = hrdp_beta_actions__action__CameraRGB_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_Feedback__Sequence__init(hrdp_beta_actions__action__CameraRGB_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_Feedback * data = NULL;

  if (size) {
    data = (hrdp_beta_actions__action__CameraRGB_Feedback *)allocator.zero_allocate(size, sizeof(hrdp_beta_actions__action__CameraRGB_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hrdp_beta_actions__action__CameraRGB_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        hrdp_beta_actions__action__CameraRGB_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
hrdp_beta_actions__action__CameraRGB_Feedback__Sequence__fini(hrdp_beta_actions__action__CameraRGB_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      hrdp_beta_actions__action__CameraRGB_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_Feedback__Sequence * array = (hrdp_beta_actions__action__CameraRGB_Feedback__Sequence *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hrdp_beta_actions__action__CameraRGB_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_Feedback__Sequence__destroy(hrdp_beta_actions__action__CameraRGB_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hrdp_beta_actions__action__CameraRGB_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hrdp_beta_actions__action__CameraRGB_Feedback__Sequence__are_equal(const hrdp_beta_actions__action__CameraRGB_Feedback__Sequence * lhs, const hrdp_beta_actions__action__CameraRGB_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hrdp_beta_actions__action__CameraRGB_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hrdp_beta_actions__action__CameraRGB_Feedback);
    hrdp_beta_actions__action__CameraRGB_Feedback * data =
      (hrdp_beta_actions__action__CameraRGB_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hrdp_beta_actions__action__CameraRGB_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          hrdp_beta_actions__action__CameraRGB_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
hrdp_beta_actions__action__CameraRGB_SendGoal_Request__init(hrdp_beta_actions__action__CameraRGB_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    hrdp_beta_actions__action__CameraRGB_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!hrdp_beta_actions__action__CameraRGB_Goal__init(&msg->goal)) {
    hrdp_beta_actions__action__CameraRGB_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
hrdp_beta_actions__action__CameraRGB_SendGoal_Request__fini(hrdp_beta_actions__action__CameraRGB_SendGoal_Request * msg)
{
  ...
  // goal
  hrdp_beta_actions__action__CameraRGB_Goal__fini(&msg->goal);
}
...
hrdp_beta_actions__action__CameraRGB_SendGoal_Request__are_equal(const hrdp_beta_actions__action__CameraRGB_SendGoal_Request * lhs, const hrdp_beta_actions__action__CameraRGB_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!hrdp_beta_actions__action__CameraRGB_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_SendGoal_Request * msg = (hrdp_beta_actions__action__CameraRGB_SendGoal_Request *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hrdp_beta_actions__action__CameraRGB_SendGoal_Request));
  bool success = hrdp_beta_actions__action__CameraRGB_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence__init(hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_SendGoal_Request * data = NULL;

  if (size) {
    data = (hrdp_beta_actions__action__CameraRGB_SendGoal_Request *)allocator.zero_allocate(size, sizeof(hrdp_beta_actions__action__CameraRGB_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hrdp_beta_actions__action__CameraRGB_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        hrdp_beta_actions__action__CameraRGB_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence__fini(hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      hrdp_beta_actions__action__CameraRGB_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence * array = (hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence__destroy(hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence__are_equal(const hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence * lhs, const hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hrdp_beta_actions__action__CameraRGB_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hrdp_beta_actions__action__CameraRGB_SendGoal_Request);
    hrdp_beta_actions__action__CameraRGB_SendGoal_Request * data =
      (hrdp_beta_actions__action__CameraRGB_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hrdp_beta_actions__action__CameraRGB_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          hrdp_beta_actions__action__CameraRGB_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
hrdp_beta_actions__action__CameraRGB_SendGoal_Response__init(hrdp_beta_actions__action__CameraRGB_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    hrdp_beta_actions__action__CameraRGB_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_SendGoal_Response * msg = (hrdp_beta_actions__action__CameraRGB_SendGoal_Response *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hrdp_beta_actions__action__CameraRGB_SendGoal_Response));
  bool success = hrdp_beta_actions__action__CameraRGB_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence__init(hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_SendGoal_Response * data = NULL;

  if (size) {
    data = (hrdp_beta_actions__action__CameraRGB_SendGoal_Response *)allocator.zero_allocate(size, sizeof(hrdp_beta_actions__action__CameraRGB_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hrdp_beta_actions__action__CameraRGB_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        hrdp_beta_actions__action__CameraRGB_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence__fini(hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      hrdp_beta_actions__action__CameraRGB_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence * array = (hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence__destroy(hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence__are_equal(const hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence * lhs, const hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hrdp_beta_actions__action__CameraRGB_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hrdp_beta_actions__action__CameraRGB_SendGoal_Response);
    hrdp_beta_actions__action__CameraRGB_SendGoal_Response * data =
      (hrdp_beta_actions__action__CameraRGB_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hrdp_beta_actions__action__CameraRGB_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          hrdp_beta_actions__action__CameraRGB_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
hrdp_beta_actions__action__CameraRGB_GetResult_Request__init(hrdp_beta_actions__action__CameraRGB_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    hrdp_beta_actions__action__CameraRGB_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_GetResult_Request * msg = (hrdp_beta_actions__action__CameraRGB_GetResult_Request *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hrdp_beta_actions__action__CameraRGB_GetResult_Request));
  bool success = hrdp_beta_actions__action__CameraRGB_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence__init(hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_GetResult_Request * data = NULL;

  if (size) {
    data = (hrdp_beta_actions__action__CameraRGB_GetResult_Request *)allocator.zero_allocate(size, sizeof(hrdp_beta_actions__action__CameraRGB_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hrdp_beta_actions__action__CameraRGB_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        hrdp_beta_actions__action__CameraRGB_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence__fini(hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      hrdp_beta_actions__action__CameraRGB_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence * array = (hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence__destroy(hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence__are_equal(const hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence * lhs, const hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hrdp_beta_actions__action__CameraRGB_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hrdp_beta_actions__action__CameraRGB_GetResult_Request);
    hrdp_beta_actions__action__CameraRGB_GetResult_Request * data =
      (hrdp_beta_actions__action__CameraRGB_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hrdp_beta_actions__action__CameraRGB_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          hrdp_beta_actions__action__CameraRGB_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
hrdp_beta_actions__action__CameraRGB_GetResult_Response__init(hrdp_beta_actions__action__CameraRGB_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!hrdp_beta_actions__action__CameraRGB_Result__init(&msg->result)) {
    hrdp_beta_actions__action__CameraRGB_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
hrdp_beta_actions__action__CameraRGB_GetResult_Response__fini(hrdp_beta_actions__action__CameraRGB_GetResult_Response * msg)
{
  ...
  // status
  // result
  hrdp_beta_actions__action__CameraRGB_Result__fini(&msg->result);
}
...
hrdp_beta_actions__action__CameraRGB_GetResult_Response__are_equal(const hrdp_beta_actions__action__CameraRGB_GetResult_Response * lhs, const hrdp_beta_actions__action__CameraRGB_GetResult_Response * rhs)
{
  ...
  // result
  if (!hrdp_beta_actions__action__CameraRGB_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_GetResult_Response * msg = (hrdp_beta_actions__action__CameraRGB_GetResult_Response *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hrdp_beta_actions__action__CameraRGB_GetResult_Response));
  bool success = hrdp_beta_actions__action__CameraRGB_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence__init(hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_GetResult_Response * data = NULL;

  if (size) {
    data = (hrdp_beta_actions__action__CameraRGB_GetResult_Response *)allocator.zero_allocate(size, sizeof(hrdp_beta_actions__action__CameraRGB_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hrdp_beta_actions__action__CameraRGB_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        hrdp_beta_actions__action__CameraRGB_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence__fini(hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      hrdp_beta_actions__action__CameraRGB_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence * array = (hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence__destroy(hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence__are_equal(const hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence * lhs, const hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hrdp_beta_actions__action__CameraRGB_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hrdp_beta_actions__action__CameraRGB_GetResult_Response);
    hrdp_beta_actions__action__CameraRGB_GetResult_Response * data =
      (hrdp_beta_actions__action__CameraRGB_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hrdp_beta_actions__action__CameraRGB_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          hrdp_beta_actions__action__CameraRGB_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
hrdp_beta_actions__action__CameraRGB_FeedbackMessage__init(hrdp_beta_actions__action__CameraRGB_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    hrdp_beta_actions__action__CameraRGB_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!hrdp_beta_actions__action__CameraRGB_Feedback__init(&msg->feedback)) {
    hrdp_beta_actions__action__CameraRGB_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
hrdp_beta_actions__action__CameraRGB_FeedbackMessage__fini(hrdp_beta_actions__action__CameraRGB_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  hrdp_beta_actions__action__CameraRGB_Feedback__fini(&msg->feedback);
}
...
hrdp_beta_actions__action__CameraRGB_FeedbackMessage__are_equal(const hrdp_beta_actions__action__CameraRGB_FeedbackMessage * lhs, const hrdp_beta_actions__action__CameraRGB_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!hrdp_beta_actions__action__CameraRGB_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_FeedbackMessage * msg = (hrdp_beta_actions__action__CameraRGB_FeedbackMessage *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hrdp_beta_actions__action__CameraRGB_FeedbackMessage));
  bool success = hrdp_beta_actions__action__CameraRGB_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence__init(hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_FeedbackMessage * data = NULL;

  if (size) {
    data = (hrdp_beta_actions__action__CameraRGB_FeedbackMessage *)allocator.zero_allocate(size, sizeof(hrdp_beta_actions__action__CameraRGB_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hrdp_beta_actions__action__CameraRGB_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        hrdp_beta_actions__action__CameraRGB_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence__fini(hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      hrdp_beta_actions__action__CameraRGB_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence * array = (hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence *)allocator.allocate(sizeof(hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence__destroy(hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence__are_equal(const hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence * lhs, const hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hrdp_beta_actions__action__CameraRGB_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hrdp_beta_actions__action__CameraRGB_FeedbackMessage);
    hrdp_beta_actions__action__CameraRGB_FeedbackMessage * data =
      (hrdp_beta_actions__action__CameraRGB_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hrdp_beta_actions__action__CameraRGB_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          hrdp_beta_actions__action__CameraRGB_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!hrdp_beta_actions__action__CameraRGB_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
